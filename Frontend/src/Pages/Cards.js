...
export class Card extends Component{
    ...
    <header>
    <h3 className="d-flex justify-content-center header-1">DashBoard</h3>
    </header>
        ...
        <MDBRow className='row-cols-1 row-cols-md-3 g-4'>
          <MDBCol>
            <MDBCard className='h-100'>
              ...
              <MDBCardBody>
                   <MDBCardLink href='/projects'>Visit the page</MDBCardLink>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
          <MDBCol>
            <MDBCard className='h-100'>
              ...
              <MDBCardBody>
                   <MDBCardLink href='https://askgenie.hexaware.com/'>Visit the page</MDBCardLink>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
          {/* <MDBCol>
          ...
          <MDBCol>
            <MDBCard className='h-100'>
              ...
              <MDBCardBody>
                   <MDBCardLink href='/forms'>Visit the page</MDBCardLink>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
        </MDBRow>
